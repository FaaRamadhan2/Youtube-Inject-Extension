...
(() => {
  ...
  function featureCss() {
    ...
    return `
      ...
      tp-yt-app-header,tp-yt-app-header #background,tp-yt-app-header #backgroundRearLayer,tp-yt-app-header #backgroundFrontLayer,tp-yt-app-header #contentContainer,ytd-tabbed-page-header,ytd-tabbed-page-header #page-header-container,ytd-tabbed-page-header #page-header,ytd-tabbed-page-header #page-header-banner,ytd-tabbed-page-header #page-header-banner-sizer,ytd-tabbed-page-header #tabs-container,ytd-tabbed-page-header #tabs-inner-container,ytd-tabbed-page-header #tabs-divider,tp-yt-app-toolbar,yt-page-header-renderer,yt-page-header-view-model,.ytPageHeaderViewModelContent,.ytPageHeaderViewModelHeadline,.ytPageHeaderViewModelHeadlineInfo{background:transparent!important;background-color:transparent!important}
    `;
  }
